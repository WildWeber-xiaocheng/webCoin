...
type RegReq struct {
	...
	Ip           string      `protobuf:"bytes,9,opt,name=ip,proto3" json:"ip,omitempty"` //用于人机验证
}
...
var file_register_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x70, 0x22, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x52, 0x65, 0x73, 0x22, 0x3a, 0x0a,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x39, 0x0a, 0x07, 0x43, 0x6f, 0x64,
	...
	0x6e, 0x74, 0x72, 0x79, 0x22, 0x07, 0x0a, 0x05, 0x4e, 0x6f, 0x52, 0x65, 0x73, 0x32, 0x71, 0x0a,
...
var file_register_proto_goTypes = []interface{}{
	...
	(*RegRes)(nil),     // 1: register.RegRes
	(*CaptchaReq)(nil), // 2: register.CaptchaReq
	(*CodeReq)(nil),    // 3: register.CodeReq
	(*NoRes)(nil),      // 4: register.NoRes
}
var file_register_proto_depIdxs = []int32{
	2, // 0: register.RegReq.captcha:type_name -> register.CaptchaReq
	...
	1, // 3: register.Register.registerByPhone:output_type -> register.RegRes
